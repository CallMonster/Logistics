 ...
 */
public class OrderTask_ArriverAdapter extends RecyclerView.Adapter<OrderTask_ArriverAdapter.ItemViewHolder> {

    private Context context;
    private List<OrderListBean> orderList;
    private String stateStr;
    public OrderTask_ArriverAdapter(Context context, List<OrderListBean> orderList, int state){
    ...
    public void onBindViewHolder(ItemViewHolder holder, int position) {
        ...
        holder.timeView.setText("送达时间："+item.getCallTime());
