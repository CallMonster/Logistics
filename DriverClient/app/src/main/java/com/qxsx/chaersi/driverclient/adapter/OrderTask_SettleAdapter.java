 ...
 */
public class OrderTask_SettleAdapter extends RecyclerView.Adapter<OrderTask_SettleAdapter.ItemViewHolder> {

    private Context context;
    private List<OrderListBean> orderList;
    private String stateStr;
    public OrderTask_SettleAdapter(Context context, List<OrderListBean> orderList, int state){
    ...
    public void onBindViewHolder(ItemViewHolder holder, int position) {
        ...
        holder.timeView.setText("结算时间："+item.getCallTime());
