package com.zt.hackman.customshape.widget;
...
public final class RoundedTransformationBuilder {
	 ...
	 * 
	 * @Override public Bitmap transform(Bitmap source) { Bitmap transformed =
	 * RoundedDrawable.fromBitmap(source) .setScaleType(mScaleType)
	 * .setCornerRadius(mCornerRadius) .setBorderWidth(mBorderWidth)
	 * .setBorderColor(mBorderColor) .setOval(mOval) .toBitmap(); if
	 * (!source.equals(transformed)) { source.recycle(); } return transformed; }
	 * 
	 * @Override public String key() { return "r:" + mCornerRadius + "b:" +
