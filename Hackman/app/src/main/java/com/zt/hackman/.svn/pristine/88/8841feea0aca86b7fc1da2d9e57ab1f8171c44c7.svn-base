package com.zt.hackman.constant;
...
public class Constant {
    ...
    public static final String TEST_HOST  = "http://192.168.3.23/";
    ...
    public static class PREFERENCE_KEY{
        ...
        public static final String KEY_HACK_RESPONSE = "hack_response";
    }

    public static final int order_pageSize = 10;
    public static final int home_pageSize = 10;
