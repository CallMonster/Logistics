...
public class ProgressActivity extends RelativeLayout {
	...
	private void switchState(String state, Drawable drawable, String errorText,
		...
		case EMPTY:
			...
			//加载默认图片
			emptyStateImageView.setImageDrawable(drawable!=null ? drawable : getResources().getDrawable(R.mipmap.wb_loading_frame1));
		...
		case ERROR:
			...
			errorStateImageView.setImageDrawable(drawable!=null ? drawable : getResources().getDrawable(R.mipmap.wb_loading_frame1));
